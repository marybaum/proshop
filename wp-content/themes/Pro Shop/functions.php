 ...
 * Pro Shop.
 *
 * This file adds functions to the Pro Shop theme.
 *
 * @package Pro_Shop
 * @author  marybaum
 * @license GPL-2.0+
...
/*
//Nuke all the Woocommerce styles
add_filter( 'woocommerce_enqueue_styles' , '__return_false');
*/
/*
// Just in case ...
// Remove Woocommerce stylesheets one by one
add_filter( 'woocommerce_enqueue_styles', 'proshop_dequeue_styles' );
function proshop_dequeue_styles( $enqueue_styles ) {
